...
void EventSystem::ResolveRandomEvent(std::shared_ptr<Entity> player, int& partyScrap) {
    // Randomly select one of the narrative events
    int roll = rand() % 3;
...
// =========================================================
// NARRATIVE EVENT 1: The Cave-In (From GDD)
// =========================================================
void EventSystem::EventCaveIn(std::shared_ptr<Entity> player, int& partyScrap) {
    ...
    if (choice == 1) {
        ...
        if (player->GetTotalStat(DEX) >= 14) {
            ...
            player->ApplyStatus({BLEED, "Deep Gash", 3, 5}); // Applies Bleed debuff
        }
    }
}

// =========================================================
// NARRATIVE EVENT 2: Mutated Alchemist (From Progression Details)
// =========================================================
...
// =========================================================
// NARRATIVE EVENT 3: The Black Market (From GDD Tier 1)
// =========================================================
void EventSystem::EventBlackMarket(std::shared_ptr<Entity> player) {
    ...
    if (choice == 1) {
        ...
        else if (statChoice == 4) { player->ModifyBaseStat(INT, 4); std::cout << "*** +4 INT! ***\n"; }
